...
# --- 1. सबसे ज़रूरी: फ्लैश रोकने और पुराना साइडबार पूरी तरह बंद करने के लिए (ब्रह्मास्त्र) ---
st.markdown("""
    <style>
    /* Streamlit के डिफ़ॉल्ट नेविगेशन को पूरी तरह गायब करने का लॉजिक */
    ...
    /* पेज लोड होते ही कंटेंट को स्मूथली दिखाएं */
...
st.markdown("""
    ...
    [data-testid="stSidebar"] {
        ...
        display: block !important; /* साइडबार को हमेशा चालू रखें */
...
with col1:
    ...
    st.markdown("Traditional Roots, Modern Approach.")
