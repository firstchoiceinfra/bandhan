...
st.markdown("<p style='text-align:center; font-size:1.2rem; color:gray;'>Step-by-step verified wedding services and professional planners. Select services and track your grand total in real-time (₹).</p>", unsafe_allow_html=True)
st.markdown("---")

# 5. Dynamic Tabs for Services & Cart
tab1, tab2 = st.tabs(["📋 Step-by-Step Wedding Services & Planner", "🛒 My Wedding Planner Cart"])
...
with tab1:
    ...
    with c2:
        ...
        st.write("Don't want the hassle of managing individual vendors? Hand over complete event execution, guest hospitality, and logistics to top-rated professional planners.")
    ...
    with c2:
        ...
        st.write("Spacious air-conditioned hall with a massive green lawn, stage setup, power backup, and guest stay rooms.")
    ...
    with c2:
        ...
        st.write("HD airbrush bridal makeup, hair styling, draping, pre-wedding trial, and groom grooming session by professional artists.")
    ...
    # --- SERVICE 9: Rituals & Pandit Ji (पंडित जी) ---
    st.markdown("<div class='step-box'><span class='step-number'>Service 9</span><h2 style='display:inline; margin-left:10px; color:#1A365D;'>🕉️ Vedic Priest & Ritual Services</h2></div>", unsafe_allow_html=True)
    c1, c2 = st.columns([1, 2], gap="medium")
    with c1:
    ...
    with c2:
        ...
        if st.button("➕ Add Priest Services to Cart", key="btn_step8"):
